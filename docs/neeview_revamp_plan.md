...
> **进度（2025-11-21 更新）**：
> - ✅ 纵向滚动模式数据加载逻辑已完成，支持多页预加载和滚动加载
> - ✅ 全景模式相邻图片填充已完成，支持左右相邻图片填充边框空隙
> - ✅ 视频缩略图生成和显示已完成，集成 FFmpeg 支持，支持多种视频格式
> - ✅ 多标签模式基础架构已完成（TabManager），支持多书籍标签管理
> - ✅ 多开模式基础架构已完成（WindowManager），支持创建多个查看器窗口
