...
use super::types::{BenchmarkReport, BenchmarkResult, BitmapLoadResult, LoadModeTestResult};

#[cfg(target_os = "windows")]
use super::thumbnail_benchmark::{generate_thumbnail_with_format, generate_thumbnail_with_wic};
