...
/// WIC + LZ4 缓存
pub static WIC_LZ4_CACHE: Lazy<Mutex<HashMap<String, WicLz4Result>>> =
...
pub async fn load_image_wic_lz4(
    ...
    let image_data = manager
        .extract_file(Path::new(&archive_path), &file_path)
