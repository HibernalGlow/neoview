...
<div class="space-y-4">
	...
	{#if translatedText || error}
		<div class="space-y-2">
			...
			{#if error}
				<div
					class="flex items-start gap-2 rounded-md border border-red-500/30 bg-red-500/10 p-3 text-sm text-red-600 dark:text-red-400"
				>
			...
			{:else if translatedText}
				<div
					class="flex items-start gap-2 rounded-md border border-green-500/30 bg-green-500/10 p-3 text-sm text-green-600 dark:text-green-400"
				>
	...
	<!-- 示例 -->
	<div class="space-y-1">
		<Label class="text-muted-foreground text-xs">快速测试示例</Label>
