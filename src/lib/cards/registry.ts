...
import { Eye, Timer, Layers, FolderOpen, FileText, Image, Cpu, History, Tags, Search, Activity, Gauge, Archive, Globe, ListChecks, BarChart3, Languages, Settings, Mic, Bot, ScanSearch, Clock, Monitor, Bell, Star, Zap, Loader, Sparkles, Bookmark, TrendingUp, Flame, Calendar, FastForward, BookOpen, Settings2, Database, List, Info, PanelLeft, HardDrive, Network, Sliders, Tag, Images, Boxes, TestTube, RefreshCw, Heart, PieChart } from '@lucide/svelte';
