...
<div class="space-y-3 text-xs">
	...
	<div class="space-y-2">
		...
		{#if cacheStats.value.cacheDir}
			<p class="text-muted-foreground truncate text-[10px]" title={cacheStats.value.cacheDir}>
	...
	<div class="flex items-center justify-between">
		...
		<select class="bg-muted h-6 rounded border-0 px-2 text-xs" bind:value={cleanupDays}>
	...
	<div class="flex gap-2">
		...
		<Button
			variant="outline"
			size="sm"
			class="text-destructive hover:text-destructive h-7 flex-1 text-xs"
