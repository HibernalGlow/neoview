<script lang="ts">
	...
	let { folderTreeConfig, inlineTreeMode, onSetFolderTreeLayout, onToggleInlineTree }: Props =
		$props();
...
<div class="border-border/50 flex flex-wrap items-center gap-1 border-t px-2 py-1">
	<span class="text-muted-foreground mr-1 text-xs">文件树位置</span>
