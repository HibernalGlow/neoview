...
export const tabSelectedItems = derived(
	activeTab,
...
export const tabShowPenetrateSettingsBar = derived(
	activeTab,
	($tab) => $tab?.showPenetrateSettingsBar || false
);
...
export const tabSearchSettings = derived(
	activeTab,
	($tab) =>
		$tab?.searchSettings || {
...
export const tabExpandedFolders = derived(
	activeTab,
...
export const tabThumbnailWidthPercent = derived(
	activeTab,
...
export const tabCanGoForwardTab = derived(
	store,
