...
import type { TabBarLayout, BreadcrumbPosition, ToolbarPosition, PanelMode } from './types';
import { getPerPanelLayoutSettings, setPerPanelLayoutSettings } from './tabManagement.svelte';
...
// folder 面板
export const folderTabBarLayout = writable<TabBarLayout>(
	perPanelLayoutSettings.folder.tabBarLayout
);
export const folderTabBarWidth = writable<number>(perPanelLayoutSettings.folder.tabBarWidth);
export const folderBreadcrumbPosition = writable<BreadcrumbPosition>(
	perPanelLayoutSettings.folder.breadcrumbPosition
);
export const folderToolbarPosition = writable<ToolbarPosition>(
	perPanelLayoutSettings.folder.toolbarPosition
);

// bookmark 面板
export const bookmarkTabBarLayout = writable<TabBarLayout>(
	perPanelLayoutSettings.bookmark.tabBarLayout
);
export const bookmarkTabBarWidth = writable<number>(perPanelLayoutSettings.bookmark.tabBarWidth);
export const bookmarkBreadcrumbPosition = writable<BreadcrumbPosition>(
	perPanelLayoutSettings.bookmark.breadcrumbPosition
);
export const bookmarkToolbarPosition = writable<ToolbarPosition>(
	perPanelLayoutSettings.bookmark.toolbarPosition
);

// history 面板
export const historyTabBarLayout = writable<TabBarLayout>(
	perPanelLayoutSettings.history.tabBarLayout
);
export const historyTabBarWidth = writable<number>(perPanelLayoutSettings.history.tabBarWidth);
export const historyBreadcrumbPosition = writable<BreadcrumbPosition>(
	perPanelLayoutSettings.history.breadcrumbPosition
);
export const historyToolbarPosition = writable<ToolbarPosition>(
	perPanelLayoutSettings.history.toolbarPosition
);
...
/** 设置面包屑位置（按面板类型） */
export function setBreadcrumbPosition(
	position: BreadcrumbPosition,
	mode: PanelMode = 'folder'
): void {
	const settings = getPerPanelLayoutSettings();
