...
<div
	...
	style:background-color={['ambient', 'aurora', 'spotlight'].includes(mode)
		? 'var(--background)'
		: effectiveColor}
...
>
	...
	{:else if mode === 'aurora'}
		...
		<div class="aurora-container">
			<div class="aurora-effect" class:aurora-masked={auroraShowRadialGradient}></div>
		</div>
...
<style>
	...
	@keyframes float-vibrant-4 {
		...
		50% {
			transform: translate(5%, -15%) scale(0.85) rotate(5deg);
		}
		75% {
			transform: translate(10%, -5%) scale(1) rotate(-3deg);
		}
	}
	...
	@keyframes float-dynamic-4 {
		...
		20% {
			transform: translate(-15%, -15%) scale(1.25) rotate(-18deg);
		}
		40% {
			transform: translate(10%, -25%) scale(0.75) rotate(12deg);
		}
		60% {
			transform: translate(20%, -10%) scale(1.1) rotate(-5deg);
		}
		80% {
			transform: translate(-5%, 15%) scale(0.95) rotate(8deg);
		}
	}
	@keyframes float-dynamic-5 {
		...
		25% {
			transform: translate(25%, 20%) scale(0.7) rotate(20deg);
		}
		50% {
			transform: translate(-15%, 30%) scale(1.3) rotate(-15deg);
		}
		75% {
			transform: translate(-25%, 5%) scale(0.85) rotate(10deg);
		}
	}
	@keyframes float-dynamic-6 {
		...
		25% {
			transform: translate(-20%, -25%) scale(1.2) rotate(-20deg);
		}
		50% {
			transform: translate(20%, -20%) scale(0.8) rotate(15deg);
		}
		75% {
