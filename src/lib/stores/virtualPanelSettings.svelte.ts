...
class VirtualPanelSettingsStore {
	...
	get historyViewStyle() {
		return this.historySettings.viewStyle;
	}
	get historySortField() {
		return this.historySettings.sortField;
	}
	get historySortOrder() {
		return this.historySettings.sortOrder;
	}
	get historyItemTypeFilter() {
		return this.historySettings.itemTypeFilter;
	}
	get historyMultiSelectMode() {
		return this.historySettings.multiSelectMode;
	}
	get historyDeleteMode() {
		return this.historySettings.deleteMode;
	}
	get historyShowSearchBar() {
		return this.historySettings.showSearchBar;
	}
	get historyShowMigrationBar() {
		return this.historySettings.showMigrationBar;
	}
	get historyPenetrateMode() {
		return this.historySettings.penetrateMode;
	}
	get historyInlineTreeMode() {
		return this.historySettings.inlineTreeMode;
	}
	get historyThumbnailWidthPercent() {
		return this.historySettings.thumbnailWidthPercent;
	}
	get historyFolderTreeVisible() {
		return this.historySettings.folderTreeVisible;
	}
	get historyFolderTreeLayout() {
		return this.historySettings.folderTreeLayout;
	}
	get historyFolderTreeSize() {
		return this.historySettings.folderTreeSize;
	}
	get historyFolderTreeConfig() {
		return {
			visible: this.historySettings.folderTreeVisible,
			layout: this.historySettings.folderTreeLayout,
			size: this.historySettings.folderTreeSize
		};
	}
	get historyShowToolbarTooltip() {
		return this.historySettings.showToolbarTooltip;
	}

	// Bookmark panel getters
	get bookmarkViewStyle() {
		return this.bookmarkSettings.viewStyle;
	}
	get bookmarkSortField() {
		return this.bookmarkSettings.sortField;
	}
	get bookmarkSortOrder() {
		return this.bookmarkSettings.sortOrder;
	}
	get bookmarkItemTypeFilter() {
		return this.bookmarkSettings.itemTypeFilter;
	}
	get bookmarkMultiSelectMode() {
		return this.bookmarkSettings.multiSelectMode;
	}
	get bookmarkDeleteMode() {
		return this.bookmarkSettings.deleteMode;
	}
	get bookmarkShowSearchBar() {
		return this.bookmarkSettings.showSearchBar;
	}
	get bookmarkShowMigrationBar() {
		return this.bookmarkSettings.showMigrationBar;
	}
	get bookmarkPenetrateMode() {
		return this.bookmarkSettings.penetrateMode;
	}
	get bookmarkInlineTreeMode() {
		return this.bookmarkSettings.inlineTreeMode;
	}
	get bookmarkThumbnailWidthPercent() {
		return this.bookmarkSettings.thumbnailWidthPercent;
	}
	get bookmarkFolderTreeVisible() {
		return this.bookmarkSettings.folderTreeVisible;
	}
	get bookmarkFolderTreeLayout() {
		return this.bookmarkSettings.folderTreeLayout;
	}
	get bookmarkFolderTreeSize() {
		return this.bookmarkSettings.folderTreeSize;
	}
	get bookmarkFolderTreeConfig() {
		return {
			visible: this.bookmarkSettings.folderTreeVisible,
			layout: this.bookmarkSettings.folderTreeLayout,
			size: this.bookmarkSettings.folderTreeSize
		};
	}
	get bookmarkShowToolbarTooltip() {
		return this.bookmarkSettings.showToolbarTooltip;
	}
	...
	setHistorySort(field: FolderSortField, order?: FolderSortOrder) {
		const newOrder =
			order ??
			(this.historySettings.sortField === field && this.historySettings.sortOrder === 'asc'
				? 'desc'
				: 'asc');
	...
	setBookmarkSort(field: FolderSortField, order?: FolderSortOrder) {
		const newOrder =
			order ??
			(this.bookmarkSettings.sortField === field && this.bookmarkSettings.sortOrder === 'asc'
				? 'desc'
				: 'asc');
