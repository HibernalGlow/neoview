...
const iconSvgPaths: Record<string, string> = {
	...
	Boxes: '<path d="M2.97 12.92 12 17.5l9.03-4.58"/><path d="M12 22V12"/><path d="m7 10-4.03 2.92L12 17.5l9.03-4.58L17 10"/><path d="m7 10 5 2.5 5-2.5"/><path d="M7 10V5l5-2.5L17 5v5"/>',
	...
	Flame: '<path d="M8.5 14.5A2.5 2.5 0 0 0 11 17c1.4 0 2.5-1.1 2.5-2.5 0-.9-.4-1.6-1-2.1-.6-.5-1.5-1.2-1.5-2.4 0-.8.4-1.5 1-2 2.2 1.4 4 4.2 4 7a4 4 0 1 1-8 0Z"/><path d="M12 2C9 5 5 7.5 5 13a7 7 0 0 0 14 0c0-4.5-2.5-7.5-7-11Z"/>',
	...
	Heart: '<path d="M19 14c1.5-1.5 3-3.2 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.8 0-3 .8-4.5 2.3C10.5 3.8 9.3 3 7.5 3A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4 3 5.5l7 7Z"/>',
	...
	Layers: '<path d="m12.8 2.6 8.4 4.7a1 1 0 0 1 0 1.8l-8.4 4.7a1.7 1.7 0 0 1-1.6 0L2.8 9.1a1 1 0 0 1 0-1.8l8.4-4.7a1.7 1.7 0 0 1 1.6 0Z"/><path d="m22 12-9.2 5.2a1.7 1.7 0 0 1-1.6 0L2 12"/><path d="m22 17-9.2 5.2a1.7 1.7 0 0 1-1.6 0L2 17"/>',
	List: '<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/>',
	ListChecks: '<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>',
	Loader: '<path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/>',
	Mic: '<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/>',
	Monitor: '<rect width="20" height="14" x="2" y="3" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>',
	Network: '<rect x="16" y="16" width="6" height="6" rx="1"/><rect x="2" y="16" width="6" height="6" rx="1"/><rect x="9" y="2" width="6" height="6" rx="1"/><path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3"/><path d="M12 8v4"/>',
	Palette: '<circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6 2 11.5 2 16 5.5 20 10 20h1.5a2.5 2.5 0 0 0 0-5H11a2 2 0 0 1 0-4h1a10 10 0 0 0 7-3 6 6 0 0 0-7-6Z"/>',
	PanelLeft: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/>',
	PieChart: '<path d="M21 12c.6 0 1-.4 1-1a10 10 0 0 0-10-10c-.6 0-1 .4-1 1v9c0 .6.4 1 1 1Z"/><path d="M21 12a9 9 0 1 1-9-9"/>',
	...
	Sliders: '<path d="M10 5H3"/><path d="M12 19H3"/><path d="M14 3v4"/><path d="M16 17v4"/><path d="M21 12h-9"/><path d="M8 10v4"/><path d="M21 5h-3"/><path d="M21 19h-1"/><path d="M8 12H3"/>',
	...
	TestTube: '<path d="M14.5 2v6.5l4.8 8.3a3.5 3.5 0 0 1-3 5.2H7.7a3.5 3.5 0 0 1-3-5.2l4.8-8.3V2"/><path d="M8.5 2h7"/><path d="M7 16h10"/>',
...
export function getActionIconSvg(action: string): string {
	...
	if (action === 'viewer.toggleHoverScroll') return svg('<path d="M12 3v12"/><path d="m8 11 4 4 4-4"/><path d="M5 19h14"/>');
	if (action === 'viewer.toggleSidebarControl') return svg(iconSvgPaths.PanelLeft);
	if (action === 'viewer.toggleCursorAutoHide') return svg('<path d="m3 3 18 18"/><path d="M5.6 5.6 12 22l2.2-7.8L22 12 5.6 5.6Z"/>');
	...
	if (action === 'viewer.toggleAutoRotate') return svg('<path d="M21 12a9 9 0 1 1-3-6.7"/><path d="M21 3v6h-6"/>');
