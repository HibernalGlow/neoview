...
// 重新导出统一 API
export { unifiedThumbnailStore, requestVisibleThumbnails, getThumbnailUrl, generateThumbKey };

// 兼容旧导出：cancelThumbnailRequests -> cancelContext
export const cancelThumbnailRequests =
	unifiedThumbnailStore.cancelContext.bind(unifiedThumbnailStore);
