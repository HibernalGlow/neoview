 ...
 */
export function adjustAnglesForFlip(angles: number[], flipState: FlipState): number[] {
 ...
 */
export function getOptimalArcDirection(pointerAngle: number, flipState: FlipState): 'cw' | 'ccw' {
