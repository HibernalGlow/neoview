 ...
 * 处理单个缩略图
 */
async function processThumbnail(id: string, data: ThumbnailWorkerMessage['data']): Promise<void> {
	if (!data) return;
 ...
 * 批量处理缩略图
 */
async function processBatchThumbnails(items: ThumbnailWorkerMessage['items']): Promise<void> {
